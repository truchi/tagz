...
pub struct BidirectionalIsolate {
    ...
    pub children: Vec<children::BidirectionalIsolateChild>,
...
impl BidirectionalIsolate {
    ...
    pub fn id<T: Into<CowStr>>(id: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().id(id)
    }
    pub fn class<T: Into<CowStr>>(class: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().class(class)
    }
    pub fn classes<T: Into<CowStr>, I: IntoIterator<Item = T>>(
        classes: I,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().classes(classes)
    }
    pub fn data<K: Into<CowStr>, V: Into<AttributeType>>(
        key: K,
        value: V,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().data(key, value)
    }
    pub fn datas<
        K: Into<CowStr>,
        V: Into<AttributeType>,
        I: IntoIterator<Item = (K, V)>,
    >(datas: I) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().datas(datas)
    }
    pub fn child<T: Into<children::BidirectionalIsolateChild>>(
        child: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().child(child)
    }
    pub fn children<
        T: Into<children::BidirectionalIsolateChild>,
        I: IntoIterator<Item = T>,
    >(children: I) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().children(children)
    }
    pub fn accesskey<T: Into<CowStr>>(
        accesskey: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default()
            .accesskey(accesskey)
    }
    ...
    pub fn dir<T: Into<CowStr>>(dir: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().dir(dir)
    }
    ...
    pub fn hidden<T: Into<BoolOrF64OrString>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().hidden(hidden)
    }
    pub fn inert<T: Into<bool>>(inert: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().inert(inert)
    }
    ...
    pub fn is<T: Into<CowStr>>(is: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().is(is)
    }
    pub fn itemid<T: Into<CowStr>>(itemid: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().itemid(itemid)
    }
    pub fn itemprop<T: Into<CowStr>>(
        itemprop: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().itemprop(itemprop)
    }
    pub fn itemref<T: Into<CowStr>>(
        itemref: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().itemref(itemref)
    }
    ...
    pub fn itemtype<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().itemtype(itemtype)
    }
    pub fn lang<T: Into<CowStr>>(lang: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().lang(lang)
    }
    pub fn nonce<T: Into<CowStr>>(nonce: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().nonce(nonce)
    }
    pub fn popover<T: Into<CowStr>>(
        popover: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().popover(popover)
    }
    pub fn slot<T: Into<CowStr>>(slot: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().slot(slot)
    }
    ...
    pub fn style<T: Into<CowStr>>(style: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().style(style)
    }
    pub fn tabindex<T: Into<i32>>(tabindex: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().tabindex(tabindex)
    }
    pub fn title<T: Into<CowStr>>(title: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().title(title)
    }
    ...
    pub fn on_blur<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_blur(on_blur)
    }
    ...
    pub fn on_click<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_click(on_click)
    }
    pub fn on_close<T: Into<CowStr>>(
        on_close: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().on_close(on_close)
    }
    ...
    pub fn on_copy<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_copy(on_copy)
    }
    ...
    pub fn on_cut<T: Into<CowStr>>(on_cut: T) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().on_cut(on_cut)
    }
    ...
    pub fn on_drag<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_drag(on_drag)
    }
    ...
    pub fn on_drop<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_drop(on_drop)
    }
    ...
    pub fn on_ended<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_ended(on_ended)
    }
    pub fn on_error<T: Into<CowStr>>(
        on_error: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().on_error(on_error)
    }
    pub fn on_focus<T: Into<CowStr>>(
        on_focus: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().on_focus(on_focus)
    }
    ...
    pub fn on_input<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_input(on_input)
    }
    ...
    pub fn on_keyup<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_keyup(on_keyup)
    }
    pub fn on_load<T: Into<CowStr>>(
        on_load: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().on_load(on_load)
    }
    ...
    pub fn on_paste<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_paste(on_paste)
    }
    pub fn on_pause<T: Into<CowStr>>(
        on_pause: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().on_pause(on_pause)
    }
    pub fn on_play<T: Into<CowStr>>(
        on_play: T,
    ) -> builders::BidirectionalIsolateBuilder {
        <builders::BidirectionalIsolateBuilder as Default>::default().on_play(on_play)
    }
    ...
    pub fn on_reset<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_reset(on_reset)
    }
    ...
    pub fn on_wheel<T: Into<CowStr>>(
        ...
        <builders::BidirectionalIsolateBuilder as Default>::default().on_wheel(on_wheel)
    }
}
impl From<builders::BidirectionalIsolateBuilder> for BidirectionalIsolate {
...
impl std::fmt::Debug for BidirectionalIsolate {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut f = f.debug_struct(&format!("<{}>", "bdi"));
