...
pub struct MapArea {
    ...
    pub coords: std::option::Option<CowStr>,
    pub dir: std::option::Option<CowStr>,
    pub download: std::option::Option<CowStr>,
    pub draggable: bool,
...
impl MapArea {
    ...
    pub fn id<T: Into<CowStr>>(id: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().id(id)
    }
    pub fn class<T: Into<CowStr>>(class: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().class(class)
    }
    pub fn classes<T: Into<CowStr>, I: IntoIterator<Item = T>>(
        classes: I,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().classes(classes)
    }
    pub fn data<K: Into<CowStr>, V: Into<AttributeType>>(
        key: K,
        value: V,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().data(key, value)
    }
    pub fn datas<
        K: Into<CowStr>,
        V: Into<AttributeType>,
        I: IntoIterator<Item = (K, V)>,
    >(datas: I) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().datas(datas)
    }
    pub fn accesskey<T: Into<CowStr>>(accesskey: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().accesskey(accesskey)
    }
    pub fn alt<T: Into<CowStr>>(alt: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().alt(alt)
    }
    pub fn autocapitalize<T: Into<CowStr>>(
        autocapitalize: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().autocapitalize(autocapitalize)
    }
    pub fn autofocus<T: Into<CowStr>>(autofocus: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().autofocus(autofocus)
    }
    pub fn contenteditable<T: Into<CowStr>>(
        contenteditable: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().contenteditable(contenteditable)
    }
    pub fn coords<T: Into<CowStr>>(coords: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().coords(coords)
    }
    pub fn dir<T: Into<CowStr>>(dir: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().dir(dir)
    }
    pub fn download<T: Into<CowStr>>(download: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().download(download)
    }
    pub fn draggable<T: Into<bool>>(draggable: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().draggable(draggable)
    }
    pub fn enterkeyhint<T: Into<CowStr>>(enterkeyhint: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().enterkeyhint(enterkeyhint)
    }
    pub fn hidden<T: Into<BoolOrF64OrString>>(hidden: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().hidden(hidden)
    }
    pub fn href<T: Into<CowStr>>(href: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().href(href)
    }
    pub fn inert<T: Into<bool>>(inert: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().inert(inert)
    }
    pub fn inputmode<T: Into<CowStr>>(inputmode: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().inputmode(inputmode)
    }
    pub fn is<T: Into<CowStr>>(is: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().is(is)
    }
    pub fn itemid<T: Into<CowStr>>(itemid: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().itemid(itemid)
    }
    pub fn itemprop<T: Into<CowStr>>(itemprop: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().itemprop(itemprop)
    }
    pub fn itemref<T: Into<CowStr>>(itemref: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().itemref(itemref)
    }
    pub fn itemscope<T: Into<CowStr>>(itemscope: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().itemscope(itemscope)
    }
    pub fn itemtype<T: Into<CowStr>>(itemtype: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().itemtype(itemtype)
    }
    pub fn lang<T: Into<CowStr>>(lang: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().lang(lang)
    }
    pub fn nonce<T: Into<CowStr>>(nonce: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().nonce(nonce)
    }
    pub fn ping<T: Into<CowStr>>(ping: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().ping(ping)
    }
    pub fn popover<T: Into<CowStr>>(popover: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().popover(popover)
    }
    pub fn referrerpolicy<T: Into<CowStr>>(
        referrerpolicy: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().referrerpolicy(referrerpolicy)
    }
    pub fn rel<T: Into<CowStr>>(rel: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().rel(rel)
    }
    pub fn shape<T: Into<CowStr>>(shape: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().shape(shape)
    }
    pub fn slot<T: Into<CowStr>>(slot: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().slot(slot)
    }
    pub fn spellcheck<T: Into<bool>>(spellcheck: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().spellcheck(spellcheck)
    }
    pub fn style<T: Into<CowStr>>(style: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().style(style)
    }
    pub fn tabindex<T: Into<CowStr>>(tabindex: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().tabindex(tabindex)
    }
    pub fn target<T: Into<CowStr>>(target: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().target(target)
    }
    pub fn title<T: Into<CowStr>>(title: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().title(title)
    }
    pub fn translate<T: Into<bool>>(translate: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().translate(translate)
    }
    pub fn on_auxclick<T: Into<CowStr>>(on_auxclick: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_auxclick(on_auxclick)
    }
    pub fn on_beforeinput<T: Into<CowStr>>(
        on_beforeinput: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_beforeinput(on_beforeinput)
    }
    pub fn on_beforematch<T: Into<CowStr>>(
        on_beforematch: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_beforematch(on_beforematch)
    }
    pub fn on_beforetoggle<T: Into<CowStr>>(
        on_beforetoggle: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_beforetoggle(on_beforetoggle)
    }
    pub fn on_blur<T: Into<CowStr>>(on_blur: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_blur(on_blur)
    }
    pub fn on_cancel<T: Into<CowStr>>(on_cancel: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_cancel(on_cancel)
    }
    pub fn on_canplay<T: Into<CowStr>>(on_canplay: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_canplay(on_canplay)
    }
    pub fn on_canplaythrough<T: Into<CowStr>>(
        on_canplaythrough: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default()
            .on_canplaythrough(on_canplaythrough)
    }
    pub fn on_change<T: Into<CowStr>>(on_change: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_change(on_change)
    }
    pub fn on_click<T: Into<CowStr>>(on_click: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_click(on_click)
    }
    pub fn on_close<T: Into<CowStr>>(on_close: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_close(on_close)
    }
    pub fn on_contextlost<T: Into<CowStr>>(
        on_contextlost: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_contextlost(on_contextlost)
    }
    pub fn on_contextmenu<T: Into<CowStr>>(
        on_contextmenu: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_contextmenu(on_contextmenu)
    }
    ...
    pub fn on_copy<T: Into<CowStr>>(on_copy: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_copy(on_copy)
    }
    pub fn on_cuechange<T: Into<CowStr>>(on_cuechange: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_cuechange(on_cuechange)
    }
    pub fn on_cut<T: Into<CowStr>>(on_cut: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_cut(on_cut)
    }
    pub fn on_dblclick<T: Into<CowStr>>(on_dblclick: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_dblclick(on_dblclick)
    }
    pub fn on_drag<T: Into<CowStr>>(on_drag: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_drag(on_drag)
    }
    pub fn on_dragend<T: Into<CowStr>>(on_dragend: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_dragend(on_dragend)
    }
    pub fn on_dragenter<T: Into<CowStr>>(on_dragenter: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_dragenter(on_dragenter)
    }
    pub fn on_dragleave<T: Into<CowStr>>(on_dragleave: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_dragleave(on_dragleave)
    }
    pub fn on_dragover<T: Into<CowStr>>(on_dragover: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_dragover(on_dragover)
    }
    pub fn on_dragstart<T: Into<CowStr>>(on_dragstart: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_dragstart(on_dragstart)
    }
    pub fn on_drop<T: Into<CowStr>>(on_drop: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_drop(on_drop)
    }
    ...
    pub fn on_emptied<T: Into<CowStr>>(on_emptied: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_emptied(on_emptied)
    }
    pub fn on_ended<T: Into<CowStr>>(on_ended: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_ended(on_ended)
    }
    pub fn on_error<T: Into<CowStr>>(on_error: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_error(on_error)
    }
    pub fn on_focus<T: Into<CowStr>>(on_focus: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_focus(on_focus)
    }
    pub fn on_formdata<T: Into<CowStr>>(on_formdata: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_formdata(on_formdata)
    }
    pub fn on_input<T: Into<CowStr>>(on_input: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_input(on_input)
    }
    pub fn on_invalid<T: Into<CowStr>>(on_invalid: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_invalid(on_invalid)
    }
    pub fn on_keydown<T: Into<CowStr>>(on_keydown: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_keydown(on_keydown)
    }
    pub fn on_keypress<T: Into<CowStr>>(on_keypress: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_keypress(on_keypress)
    }
    pub fn on_keyup<T: Into<CowStr>>(on_keyup: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_keyup(on_keyup)
    }
    pub fn on_load<T: Into<CowStr>>(on_load: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_load(on_load)
    }
    pub fn on_loadeddata<T: Into<CowStr>>(on_loadeddata: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_loadeddata(on_loadeddata)
    }
    ...
    pub fn on_loadstart<T: Into<CowStr>>(on_loadstart: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_loadstart(on_loadstart)
    }
    pub fn on_mousedown<T: Into<CowStr>>(on_mousedown: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_mousedown(on_mousedown)
    }
    pub fn on_mouseenter<T: Into<CowStr>>(on_mouseenter: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_mouseenter(on_mouseenter)
    }
    pub fn on_mouseleave<T: Into<CowStr>>(on_mouseleave: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_mouseleave(on_mouseleave)
    }
    pub fn on_mousemove<T: Into<CowStr>>(on_mousemove: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_mousemove(on_mousemove)
    }
    pub fn on_mouseout<T: Into<CowStr>>(on_mouseout: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_mouseout(on_mouseout)
    }
    pub fn on_mouseover<T: Into<CowStr>>(on_mouseover: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_mouseover(on_mouseover)
    }
    pub fn on_mouseup<T: Into<CowStr>>(on_mouseup: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_mouseup(on_mouseup)
    }
    pub fn on_paste<T: Into<CowStr>>(on_paste: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_paste(on_paste)
    }
    pub fn on_pause<T: Into<CowStr>>(on_pause: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_pause(on_pause)
    }
    pub fn on_play<T: Into<CowStr>>(on_play: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_play(on_play)
    }
    pub fn on_playing<T: Into<CowStr>>(on_playing: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_playing(on_playing)
    }
    pub fn on_progress<T: Into<CowStr>>(on_progress: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_progress(on_progress)
    }
    pub fn on_ratechange<T: Into<CowStr>>(on_ratechange: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_ratechange(on_ratechange)
    }
    pub fn on_reset<T: Into<CowStr>>(on_reset: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_reset(on_reset)
    }
    pub fn on_resize<T: Into<CowStr>>(on_resize: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_resize(on_resize)
    }
    pub fn on_scroll<T: Into<CowStr>>(on_scroll: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_scroll(on_scroll)
    }
    pub fn on_scrollend<T: Into<CowStr>>(on_scrollend: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_scrollend(on_scrollend)
    }
    ...
    pub fn on_seeked<T: Into<CowStr>>(on_seeked: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_seeked(on_seeked)
    }
    pub fn on_seeking<T: Into<CowStr>>(on_seeking: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_seeking(on_seeking)
    }
    pub fn on_select<T: Into<CowStr>>(on_select: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_select(on_select)
    }
    pub fn on_slotchange<T: Into<CowStr>>(on_slotchange: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_slotchange(on_slotchange)
    }
    pub fn on_stalled<T: Into<CowStr>>(on_stalled: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_stalled(on_stalled)
    }
    pub fn on_submit<T: Into<CowStr>>(on_submit: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_submit(on_submit)
    }
    pub fn on_suspend<T: Into<CowStr>>(on_suspend: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_suspend(on_suspend)
    }
    pub fn on_timeupdate<T: Into<CowStr>>(on_timeupdate: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_timeupdate(on_timeupdate)
    }
    pub fn on_toggle<T: Into<CowStr>>(on_toggle: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_toggle(on_toggle)
    }
    pub fn on_volumechange<T: Into<CowStr>>(
        on_volumechange: T,
    ) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_volumechange(on_volumechange)
    }
    pub fn on_waiting<T: Into<CowStr>>(on_waiting: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_waiting(on_waiting)
    }
    pub fn on_wheel<T: Into<CowStr>>(on_wheel: T) -> builders::MapAreaBuilder {
        <builders::MapAreaBuilder as Default>::default().on_wheel(on_wheel)
    }
}
impl From<builders::MapAreaBuilder> for MapArea {
    fn from(builder: builders::MapAreaBuilder) -> Self {
        builder.element
    }
}
impl std::fmt::Debug for MapArea {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut f = f.debug_struct(&format!("<{}>", "area"));
...
impl std::fmt::Display for MapArea {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        write!(f, "<{}", "area")?;
        if let Some(id) = &self.id {
            write!(f, " id=\"{id}\"")?;
        ...
        if let Some(value) = &self.coords {
            write!(f, " {}='{value}'", "coords")?;
        }
        if let Some(value) = &self.dir {
            write!(f, " {}='{value}'", "dir")?;
        }
        if let Some(value) = &self.download {
            write!(f, " {}='{value}'", "download")?;
        }
        if self.draggable {
            write!(f, " {}", "draggable")?;
        }
