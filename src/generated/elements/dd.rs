...
pub struct DescriptionDetails {
    ...
    pub children: Vec<children::DescriptionDetailsChild>,
...
impl DescriptionDetails {
    ...
    pub fn id<T: Into<CowStr>>(id: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().id(id)
    }
    pub fn class<T: Into<CowStr>>(class: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().class(class)
    }
    pub fn classes<T: Into<CowStr>, I: IntoIterator<Item = T>>(
        classes: I,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().classes(classes)
    }
    pub fn data<K: Into<CowStr>, V: Into<AttributeType>>(
        key: K,
        value: V,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().data(key, value)
    }
    pub fn datas<
        K: Into<CowStr>,
        V: Into<AttributeType>,
        I: IntoIterator<Item = (K, V)>,
    >(datas: I) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().datas(datas)
    }
    pub fn child<T: Into<children::DescriptionDetailsChild>>(
        child: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().child(child)
    }
    pub fn children<
        T: Into<children::DescriptionDetailsChild>,
        I: IntoIterator<Item = T>,
    >(children: I) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().children(children)
    }
    pub fn accesskey<T: Into<CowStr>>(
        accesskey: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().accesskey(accesskey)
    }
    pub fn autocapitalize<T: Into<CowStr>>(
        autocapitalize: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default()
            .autocapitalize(autocapitalize)
    }
    pub fn autofocus<T: Into<bool>>(
        autofocus: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().autofocus(autofocus)
    }
    ...
    pub fn dir<T: Into<CowStr>>(dir: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().dir(dir)
    }
    pub fn draggable<T: Into<bool>>(
        draggable: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().draggable(draggable)
    }
    ...
    pub fn hidden<T: Into<BoolOrF64OrString>>(
        ...
        <builders::DescriptionDetailsBuilder as Default>::default().hidden(hidden)
    }
    pub fn inert<T: Into<bool>>(inert: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().inert(inert)
    }
    pub fn inputmode<T: Into<CowStr>>(
        inputmode: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().inputmode(inputmode)
    }
    pub fn is<T: Into<CowStr>>(is: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().is(is)
    }
    pub fn itemid<T: Into<CowStr>>(itemid: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().itemid(itemid)
    }
    pub fn itemprop<T: Into<CowStr>>(
        itemprop: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().itemprop(itemprop)
    }
    pub fn itemref<T: Into<CowStr>>(itemref: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().itemref(itemref)
    }
    pub fn itemscope<T: Into<CowStr>>(
        itemscope: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().itemscope(itemscope)
    }
    pub fn itemtype<T: Into<CowStr>>(
        itemtype: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().itemtype(itemtype)
    }
    pub fn lang<T: Into<CowStr>>(lang: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().lang(lang)
    }
    pub fn nonce<T: Into<CowStr>>(nonce: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().nonce(nonce)
    }
    pub fn popover<T: Into<CowStr>>(popover: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().popover(popover)
    }
    pub fn slot<T: Into<CowStr>>(slot: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().slot(slot)
    }
    ...
    pub fn style<T: Into<CowStr>>(style: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().style(style)
    }
    pub fn tabindex<T: Into<i32>>(tabindex: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().tabindex(tabindex)
    }
    pub fn title<T: Into<CowStr>>(title: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().title(title)
    }
    pub fn translate<T: Into<bool>>(
        translate: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().translate(translate)
    }
    ...
    pub fn on_blur<T: Into<CowStr>>(on_blur: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_blur(on_blur)
    }
    pub fn on_cancel<T: Into<CowStr>>(
        on_cancel: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_cancel(on_cancel)
    }
    ...
    pub fn on_change<T: Into<CowStr>>(
        ...
        <builders::DescriptionDetailsBuilder as Default>::default().on_change(on_change)
    }
    pub fn on_click<T: Into<CowStr>>(
        on_click: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_click(on_click)
    }
    pub fn on_close<T: Into<CowStr>>(
        on_close: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_close(on_close)
    }
    ...
    pub fn on_copy<T: Into<CowStr>>(on_copy: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_copy(on_copy)
    }
    ...
    pub fn on_cut<T: Into<CowStr>>(on_cut: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_cut(on_cut)
    }
    ...
    pub fn on_drag<T: Into<CowStr>>(on_drag: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_drag(on_drag)
    }
    ...
    pub fn on_drop<T: Into<CowStr>>(on_drop: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_drop(on_drop)
    }
    ...
    pub fn on_ended<T: Into<CowStr>>(
        on_ended: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_ended(on_ended)
    }
    pub fn on_error<T: Into<CowStr>>(
        on_error: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_error(on_error)
    }
    pub fn on_focus<T: Into<CowStr>>(
        on_focus: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_focus(on_focus)
    }
    ...
    pub fn on_input<T: Into<CowStr>>(
        on_input: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_input(on_input)
    }
    ...
    pub fn on_keyup<T: Into<CowStr>>(
        on_keyup: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_keyup(on_keyup)
    }
    pub fn on_load<T: Into<CowStr>>(on_load: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_load(on_load)
    }
    ...
    pub fn on_paste<T: Into<CowStr>>(
        on_paste: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_paste(on_paste)
    }
    pub fn on_pause<T: Into<CowStr>>(
        on_pause: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_pause(on_pause)
    }
    pub fn on_play<T: Into<CowStr>>(on_play: T) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_play(on_play)
    }
    ...
    pub fn on_reset<T: Into<CowStr>>(
        on_reset: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_reset(on_reset)
    }
    pub fn on_resize<T: Into<CowStr>>(
        on_resize: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_resize(on_resize)
    }
    pub fn on_scroll<T: Into<CowStr>>(
        on_scroll: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_scroll(on_scroll)
    }
    ...
    pub fn on_seeked<T: Into<CowStr>>(
        ...
        <builders::DescriptionDetailsBuilder as Default>::default().on_seeked(on_seeked)
    }
    ...
    pub fn on_select<T: Into<CowStr>>(
        ...
        <builders::DescriptionDetailsBuilder as Default>::default().on_select(on_select)
    }
    ...
    pub fn on_submit<T: Into<CowStr>>(
        ...
        <builders::DescriptionDetailsBuilder as Default>::default().on_submit(on_submit)
    }
    ...
    pub fn on_toggle<T: Into<CowStr>>(
        ...
        <builders::DescriptionDetailsBuilder as Default>::default().on_toggle(on_toggle)
    }
    ...
    pub fn on_wheel<T: Into<CowStr>>(
        on_wheel: T,
    ) -> builders::DescriptionDetailsBuilder {
        <builders::DescriptionDetailsBuilder as Default>::default().on_wheel(on_wheel)
    }
}
impl From<builders::DescriptionDetailsBuilder> for DescriptionDetails {
...
impl std::fmt::Debug for DescriptionDetails {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut f = f.debug_struct(&format!("<{}>", "dd"));
