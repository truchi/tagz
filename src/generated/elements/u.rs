...
pub struct Underline {
    ...
    pub children: Vec<children::UnderlineChild>,
...
impl Underline {
    ...
    pub fn id<T: Into<CowStr>>(id: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().id(id)
    }
    pub fn class<T: Into<CowStr>>(class: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().class(class)
    }
    pub fn classes<T: Into<CowStr>, I: IntoIterator<Item = T>>(
        classes: I,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().classes(classes)
    }
    pub fn data<K: Into<CowStr>, V: Into<AttributeType>>(
        key: K,
        value: V,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().data(key, value)
    }
    pub fn datas<
        K: Into<CowStr>,
        V: Into<AttributeType>,
        I: IntoIterator<Item = (K, V)>,
    >(datas: I) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().datas(datas)
    }
    pub fn child<T: Into<children::UnderlineChild>>(
        child: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().child(child)
    }
    pub fn children<T: Into<children::UnderlineChild>, I: IntoIterator<Item = T>>(
        children: I,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().children(children)
    }
    pub fn accesskey<T: Into<CowStr>>(accesskey: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().accesskey(accesskey)
    }
    pub fn autocapitalize<T: Into<CowStr>>(
        autocapitalize: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().autocapitalize(autocapitalize)
    }
    pub fn autofocus<T: Into<bool>>(autofocus: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().autofocus(autofocus)
    }
    pub fn contenteditable<T: Into<CowStr>>(
        contenteditable: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default()
            .contenteditable(contenteditable)
    }
    pub fn dir<T: Into<CowStr>>(dir: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().dir(dir)
    }
    pub fn draggable<T: Into<bool>>(draggable: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().draggable(draggable)
    }
    pub fn enterkeyhint<T: Into<CowStr>>(enterkeyhint: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().enterkeyhint(enterkeyhint)
    }
    pub fn hidden<T: Into<BoolOrF64OrString>>(hidden: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().hidden(hidden)
    }
    pub fn inert<T: Into<bool>>(inert: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().inert(inert)
    }
    pub fn inputmode<T: Into<CowStr>>(inputmode: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().inputmode(inputmode)
    }
    pub fn is<T: Into<CowStr>>(is: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().is(is)
    }
    pub fn itemid<T: Into<CowStr>>(itemid: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().itemid(itemid)
    }
    pub fn itemprop<T: Into<CowStr>>(itemprop: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().itemprop(itemprop)
    }
    pub fn itemref<T: Into<CowStr>>(itemref: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().itemref(itemref)
    }
    pub fn itemscope<T: Into<CowStr>>(itemscope: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().itemscope(itemscope)
    }
    pub fn itemtype<T: Into<CowStr>>(itemtype: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().itemtype(itemtype)
    }
    pub fn lang<T: Into<CowStr>>(lang: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().lang(lang)
    }
    pub fn nonce<T: Into<CowStr>>(nonce: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().nonce(nonce)
    }
    pub fn popover<T: Into<CowStr>>(popover: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().popover(popover)
    }
    pub fn slot<T: Into<CowStr>>(slot: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().slot(slot)
    }
    pub fn spellcheck<T: Into<bool>>(spellcheck: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().spellcheck(spellcheck)
    }
    pub fn style<T: Into<CowStr>>(style: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().style(style)
    }
    pub fn tabindex<T: Into<i32>>(tabindex: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().tabindex(tabindex)
    }
    pub fn title<T: Into<CowStr>>(title: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().title(title)
    }
    pub fn translate<T: Into<bool>>(translate: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().translate(translate)
    }
    pub fn on_auxclick<T: Into<CowStr>>(on_auxclick: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_auxclick(on_auxclick)
    }
    pub fn on_beforeinput<T: Into<CowStr>>(
        on_beforeinput: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_beforeinput(on_beforeinput)
    }
    pub fn on_beforematch<T: Into<CowStr>>(
        on_beforematch: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_beforematch(on_beforematch)
    }
    ...
    pub fn on_blur<T: Into<CowStr>>(on_blur: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_blur(on_blur)
    }
    pub fn on_cancel<T: Into<CowStr>>(on_cancel: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_cancel(on_cancel)
    }
    pub fn on_canplay<T: Into<CowStr>>(on_canplay: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_canplay(on_canplay)
    }
    ...
    pub fn on_change<T: Into<CowStr>>(on_change: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_change(on_change)
    }
    pub fn on_click<T: Into<CowStr>>(on_click: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_click(on_click)
    }
    pub fn on_close<T: Into<CowStr>>(on_close: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_close(on_close)
    }
    pub fn on_contextlost<T: Into<CowStr>>(
        on_contextlost: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_contextlost(on_contextlost)
    }
    pub fn on_contextmenu<T: Into<CowStr>>(
        on_contextmenu: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_contextmenu(on_contextmenu)
    }
    ...
    pub fn on_copy<T: Into<CowStr>>(on_copy: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_copy(on_copy)
    }
    pub fn on_cuechange<T: Into<CowStr>>(on_cuechange: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_cuechange(on_cuechange)
    }
    pub fn on_cut<T: Into<CowStr>>(on_cut: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_cut(on_cut)
    }
    pub fn on_dblclick<T: Into<CowStr>>(on_dblclick: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_dblclick(on_dblclick)
    }
    pub fn on_drag<T: Into<CowStr>>(on_drag: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_drag(on_drag)
    }
    pub fn on_dragend<T: Into<CowStr>>(on_dragend: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_dragend(on_dragend)
    }
    pub fn on_dragenter<T: Into<CowStr>>(on_dragenter: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_dragenter(on_dragenter)
    }
    pub fn on_dragleave<T: Into<CowStr>>(on_dragleave: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_dragleave(on_dragleave)
    }
    pub fn on_dragover<T: Into<CowStr>>(on_dragover: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_dragover(on_dragover)
    }
    pub fn on_dragstart<T: Into<CowStr>>(on_dragstart: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_dragstart(on_dragstart)
    }
    pub fn on_drop<T: Into<CowStr>>(on_drop: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_drop(on_drop)
    }
    ...
    pub fn on_emptied<T: Into<CowStr>>(on_emptied: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_emptied(on_emptied)
    }
    pub fn on_ended<T: Into<CowStr>>(on_ended: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_ended(on_ended)
    }
    pub fn on_error<T: Into<CowStr>>(on_error: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_error(on_error)
    }
    pub fn on_focus<T: Into<CowStr>>(on_focus: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_focus(on_focus)
    }
    pub fn on_formdata<T: Into<CowStr>>(on_formdata: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_formdata(on_formdata)
    }
    pub fn on_input<T: Into<CowStr>>(on_input: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_input(on_input)
    }
    pub fn on_invalid<T: Into<CowStr>>(on_invalid: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_invalid(on_invalid)
    }
    pub fn on_keydown<T: Into<CowStr>>(on_keydown: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_keydown(on_keydown)
    }
    pub fn on_keypress<T: Into<CowStr>>(on_keypress: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_keypress(on_keypress)
    }
    pub fn on_keyup<T: Into<CowStr>>(on_keyup: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_keyup(on_keyup)
    }
    pub fn on_load<T: Into<CowStr>>(on_load: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_load(on_load)
    }
    pub fn on_loadeddata<T: Into<CowStr>>(
        on_loadeddata: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_loadeddata(on_loadeddata)
    }
    ...
    pub fn on_loadstart<T: Into<CowStr>>(on_loadstart: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_loadstart(on_loadstart)
    }
    pub fn on_mousedown<T: Into<CowStr>>(on_mousedown: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_mousedown(on_mousedown)
    }
    pub fn on_mouseenter<T: Into<CowStr>>(
        on_mouseenter: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_mouseenter(on_mouseenter)
    }
    pub fn on_mouseleave<T: Into<CowStr>>(
        on_mouseleave: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_mouseleave(on_mouseleave)
    }
    pub fn on_mousemove<T: Into<CowStr>>(on_mousemove: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_mousemove(on_mousemove)
    }
    pub fn on_mouseout<T: Into<CowStr>>(on_mouseout: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_mouseout(on_mouseout)
    }
    pub fn on_mouseover<T: Into<CowStr>>(on_mouseover: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_mouseover(on_mouseover)
    }
    pub fn on_mouseup<T: Into<CowStr>>(on_mouseup: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_mouseup(on_mouseup)
    }
    pub fn on_paste<T: Into<CowStr>>(on_paste: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_paste(on_paste)
    }
    pub fn on_pause<T: Into<CowStr>>(on_pause: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_pause(on_pause)
    }
    pub fn on_play<T: Into<CowStr>>(on_play: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_play(on_play)
    }
    pub fn on_playing<T: Into<CowStr>>(on_playing: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_playing(on_playing)
    }
    pub fn on_progress<T: Into<CowStr>>(on_progress: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_progress(on_progress)
    }
    pub fn on_ratechange<T: Into<CowStr>>(
        on_ratechange: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_ratechange(on_ratechange)
    }
    pub fn on_reset<T: Into<CowStr>>(on_reset: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_reset(on_reset)
    }
    pub fn on_resize<T: Into<CowStr>>(on_resize: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_resize(on_resize)
    }
    pub fn on_scroll<T: Into<CowStr>>(on_scroll: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_scroll(on_scroll)
    }
    pub fn on_scrollend<T: Into<CowStr>>(on_scrollend: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_scrollend(on_scrollend)
    }
    ...
    pub fn on_seeked<T: Into<CowStr>>(on_seeked: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_seeked(on_seeked)
    }
    pub fn on_seeking<T: Into<CowStr>>(on_seeking: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_seeking(on_seeking)
    }
    pub fn on_select<T: Into<CowStr>>(on_select: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_select(on_select)
    }
    pub fn on_slotchange<T: Into<CowStr>>(
        on_slotchange: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_slotchange(on_slotchange)
    }
    pub fn on_stalled<T: Into<CowStr>>(on_stalled: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_stalled(on_stalled)
    }
    pub fn on_submit<T: Into<CowStr>>(on_submit: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_submit(on_submit)
    }
    pub fn on_suspend<T: Into<CowStr>>(on_suspend: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_suspend(on_suspend)
    }
    pub fn on_timeupdate<T: Into<CowStr>>(
        on_timeupdate: T,
    ) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_timeupdate(on_timeupdate)
    }
    pub fn on_toggle<T: Into<CowStr>>(on_toggle: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_toggle(on_toggle)
    }
    ...
    pub fn on_waiting<T: Into<CowStr>>(on_waiting: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_waiting(on_waiting)
    }
    pub fn on_wheel<T: Into<CowStr>>(on_wheel: T) -> builders::UnderlineBuilder {
        <builders::UnderlineBuilder as Default>::default().on_wheel(on_wheel)
    }
}
impl From<builders::UnderlineBuilder> for Underline {
...
impl std::fmt::Debug for Underline {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let mut f = f.debug_struct(&format!("<{}>", "u"));
